...
#define __PYX_HAVE__shifting_pixel
#define __PYX_HAVE_API__shifting_pixel
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'shifting_pixel' */
...
static __Pyx_memviewslice __pyx_f_14shifting_pixel_shift(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, float, int __pyx_skip_dispatch); /*proto*/
static __Pyx_memviewslice __pyx_f_14shifting_pixel_inpainting(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, float, int __pyx_skip_dispatch); /*proto*/
static __Pyx_memviewslice __pyx_f_14shifting_pixel_overlap(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "shifting_pixel"
extern int __pyx_module_is_main_shifting_pixel;
int __pyx_module_is_main_shifting_pixel = 0;

/* Implementation of 'shifting_pixel' */
...
static const char __pyx_k_left_img[] = "left_img";
...
static const char __pyx_k_right_fix[] = "right_fix";
static const char __pyx_k_right_img[] = "right_img";
...
static PyObject *__pyx_n_s_left_img;
...
static PyObject *__pyx_n_s_right_fix;
static PyObject *__pyx_n_s_right_img;
...
static PyObject *__pyx_pf_14shifting_pixel_shift(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_left_img, __Pyx_memviewslice __pyx_v_right_img, __Pyx_memviewslice __pyx_v_depth, float __pyx_v_deviation); /* proto */
static PyObject *__pyx_pf_14shifting_pixel_2inpainting(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_right_fix, __Pyx_memviewslice __pyx_v_rows, __Pyx_memviewslice __pyx_v_cols, float __pyx_v_deviation); /* proto */
static PyObject *__pyx_pf_14shifting_pixel_4overlap(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_left_img, __Pyx_memviewslice __pyx_v_right_img, __Pyx_memviewslice __pyx_v_composite); /* proto */
...
static PyObject *__pyx_pw_14shifting_pixel_1shift(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_14shifting_pixel_shift(__Pyx_memviewslice __pyx_v_left_img, __Pyx_memviewslice __pyx_v_right_img, __Pyx_memviewslice __pyx_v_depth, float __pyx_v_deviation, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_row;
  int __pyx_v_col;
  int __pyx_v_h;
  int __pyx_v_w;
 ...
 * 
 */
  __pyx_v_h = ((int)(__pyx_v_left_img.shape[0]));

  /* "shifting_pixel.pyx":9
 *     cdef int row, col, h, w
 *     h = <int>(left_img.shape[0])
 *     w = <int>(left_img.shape[1])             # <<<<<<<<<<<<<<
 * 
 *     cdef float dis
 */
  __pyx_v_w = ((int)(__pyx_v_left_img.shape[1]));

  /* "shifting_pixel.pyx":14
 *     cdef int col_r
 * 
 *     for row in range(h):             # <<<<<<<<<<<<<<
 *         for col in range(w):
 ...
 */
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_7 < 0) {
        __pyx_t_7 += __pyx_v_depth.shape[0];
        if (unlikely(__pyx_t_7 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_7 >= __pyx_v_depth.shape[0])) __pyx_t_9 = 0;
      if (__pyx_t_8 < 0) {
        __pyx_t_8 += __pyx_v_depth.shape[1];
        if (unlikely(__pyx_t_8 < 0)) __pyx_t_9 = 1;
      } else if (unlikely(__pyx_t_8 >= __pyx_v_depth.shape[1])) __pyx_t_9 = 1;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 16, __pyx_L1_error)
      }
      __pyx_v_dis = ((1.0 - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_depth.data + __pyx_t_7 * __pyx_v_depth.strides[0]) ) + __pyx_t_8 * __pyx_v_depth.strides[1]) )))) * __pyx_v_deviation);

      /* "shifting_pixel.pyx":17
 *         for col in range(w):
 *             dis = (1.0 - depth[row, col]) * deviation
 *             col_r = col - <int>dis             # <<<<<<<<<<<<<<
 *             if col_r >= 0:
 ...
 */
      __pyx_v_col_r = (__pyx_v_col - ((int)__pyx_v_dis));

      /* "shifting_pixel.pyx":18
 *             dis = (1.0 - depth[row, col]) * deviation
 *             col_r = col - <int>dis
 *             if col_r >= 0:             # <<<<<<<<<<<<<<
 *                 right_img[row, col_r] = left_img[row, col]
 * 
 */
      __pyx_t_10 = ((__pyx_v_col_r >= 0) != 0);
      if (__pyx_t_10) {

        /* "shifting_pixel.pyx":19
 *             col_r = col - <int>dis
 *             if col_r >= 0:
 *                 right_img[row, col_r] = left_img[row, col]             # <<<<<<<<<<<<<<
 * 
 *     return right_img
 */
        __pyx_t_11.data = __pyx_v_left_img.data;
        __pyx_t_11.memview = __pyx_v_left_img.memview;
        __PYX_INC_MEMVIEW(&__pyx_t_11, 0);
        {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_row;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_left_img.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_left_img.strides[0];
...

{
    ...
    Py_ssize_t __pyx_tmp_shape = __pyx_v_left_img.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_left_img.strides[1];
    if (1 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
    if (1 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
...
__pyx_t_11.shape[0] = __pyx_v_left_img.shape[2];
__pyx_t_11.strides[0] = __pyx_v_left_img.strides[2];
    __pyx_t_11.suboffsets[0] = -1;

__pyx_t_12.data = __pyx_v_right_img.data;
        __pyx_t_12.memview = __pyx_v_right_img.memview;
        __PYX_INC_MEMVIEW(&__pyx_t_12, 0);
        {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_row;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_right_img.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_right_img.strides[0];
    if (1 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
    if (1 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
        PyErr_SetString(PyExc_IndexError, "Index out of bounds (axis 0)");
...
{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_col_r;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_right_img.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_right_img.strides[1];
    if (1 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
    if (1 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
        PyErr_SetString(PyExc_IndexError, "Index out of bounds (axis 1)");
...
__pyx_t_12.shape[0] = __pyx_v_right_img.shape[2];
__pyx_t_12.strides[0] = __pyx_v_right_img.strides[2];
    __pyx_t_12.suboffsets[0] = -1;

if (unlikely(__pyx_memoryview_copy_contents(__pyx_t_11, __pyx_t_12, 1, 1, 0) < 0)) __PYX_ERR(0, 19, __pyx_L1_error)
 ...
 * 
 */
  __PYX_INC_MEMVIEW(&__pyx_v_right_img, 0);
  __pyx_r = __pyx_v_right_img;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("shifting_pixel.shift", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
/* Python wrapper */
static PyObject *__pyx_pw_14shifting_pixel_1shift(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_14shifting_pixel_1shift(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_left_img = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_right_img = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_left_img,&__pyx_n_s_right_img,&__pyx_n_s_depth,&__pyx_n_s_deviation,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_left_img)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_right_img)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("shift", 1, 4, 4, 1); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_depth)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("shift", 1, 4, 4, 2); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_deviation)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("shift", 1, 4, 4, 3); __PYX_ERR(0, 6, __pyx_L3_error)
        }
      }
    ...
    __pyx_v_left_img = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_left_img.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_right_img = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_right_img.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_depth = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_depth.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_deviation = __pyx_PyFloat_AsFloat(values[3]); if (unlikely((__pyx_v_deviation == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("shift", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("shifting_pixel.shift", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14shifting_pixel_shift(__pyx_self, __pyx_v_left_img, __pyx_v_right_img, __pyx_v_depth, __pyx_v_deviation);
...
static PyObject *__pyx_pf_14shifting_pixel_shift(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_left_img, __Pyx_memviewslice __pyx_v_right_img, __Pyx_memviewslice __pyx_v_depth, float __pyx_v_deviation) {
  ...
  if (unlikely(!__pyx_v_left_img.memview)) { __Pyx_RaiseUnboundLocalError("left_img"); __PYX_ERR(0, 6, __pyx_L1_error) }
  if (unlikely(!__pyx_v_right_img.memview)) { __Pyx_RaiseUnboundLocalError("right_img"); __PYX_ERR(0, 6, __pyx_L1_error) }
  if (unlikely(!__pyx_v_depth.memview)) { __Pyx_RaiseUnboundLocalError("depth"); __PYX_ERR(0, 6, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_14shifting_pixel_shift(__pyx_v_left_img, __pyx_v_right_img, __pyx_v_depth, __pyx_v_deviation, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 6, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 3, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_left_img, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_right_img, 1);
...
static PyObject *__pyx_pw_14shifting_pixel_3inpainting(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_14shifting_pixel_inpainting(__Pyx_memviewslice __pyx_v_right_fix, __Pyx_memviewslice __pyx_v_rows, __Pyx_memviewslice __pyx_v_cols, float __pyx_v_deviation, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  CYTHON_UNUSED int __pyx_v_h;
  int __pyx_v_w;
  int __pyx_v_r_offset;
  int __pyx_v_l_offset;
  int __pyx_v_offset;
  __Pyx_memviewslice __pyx_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("inpainting", 0);

  /* "shifting_pixel.pyx":26
 * cpdef unsigned char [:, :, :] inpainting(unsigned char [:, :, :] right_fix, long long[:] rows, long long[:] cols, float deviation):
 *     cdef int i, j, h, w
 *     h = <int>(right_fix.shape[0])             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_h = ((int)(__pyx_v_right_fix.shape[0]));

  /* "shifting_pixel.pyx":27
 *     cdef int i, j, h, w
 *     h = <int>(right_fix.shape[0])
 *     w = <int>(right_fix.shape[1])             # <<<<<<<<<<<<<<
 *     cdef int r_offset, l_offset, offset
 * 
 */
  __pyx_v_w = ((int)(__pyx_v_right_fix.shape[1]));

  /* "shifting_pixel.pyx":30
 *     cdef int r_offset, l_offset, offset
 * 
 ...
 *             r_offset = j + offset
 */
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_rows, 1, (PyObject *(*)(char *)) __pyx_memview_get_PY_LONG_LONG, (int (*)(char *, PyObject *)) __pyx_memview_set_PY_LONG_LONG, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_cols, 1, (PyObject *(*)(char *)) __pyx_memview_get_PY_LONG_LONG, (int (*)(char *, PyObject *)) __pyx_memview_set_PY_LONG_LONG, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_1 = 0;
  __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_zip, __pyx_t_3, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
      __pyx_v_r_offset = (__pyx_v_j + __pyx_v_offset);

      /* "shifting_pixel.pyx":33
 *         for offset in range(1, <int>deviation):
 *             r_offset = j + offset
 *             l_offset = j - offset             # <<<<<<<<<<<<<<
 *             if r_offset < w and not np.all(right_fix[i, r_offset] == int(0)):
 ...
 */
      __pyx_v_l_offset = (__pyx_v_j - __pyx_v_offset);

      /* "shifting_pixel.pyx":34
 *             r_offset = j + offset
 *             l_offset = j - offset
 *             if r_offset < w and not np.all(right_fix[i, r_offset] == int(0)):             # <<<<<<<<<<<<<<
 *                 right_fix[i, j] = right_fix[i, r_offset]
 *                 break
 */
      __pyx_t_13 = ((__pyx_v_r_offset < __pyx_v_w) != 0);
      if (__pyx_t_13) {
      } else {
      ...
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_all); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 34, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_14.data = __pyx_v_right_fix.data;
      __pyx_t_14.memview = __pyx_v_right_fix.memview;
      __PYX_INC_MEMVIEW(&__pyx_t_14, 0);
      {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_i;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_right_fix.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_right_fix.strides[0];
    if (1 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
    if (1 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
        PyErr_SetString(PyExc_IndexError, "Index out of bounds (axis 0)");
...
{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_r_offset;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_right_fix.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_right_fix.strides[1];
    if (1 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
    if (1 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
        PyErr_SetString(PyExc_IndexError, "Index out of bounds (axis 1)");
...
__pyx_t_14.shape[0] = __pyx_v_right_fix.shape[2];
__pyx_t_14.strides[0] = __pyx_v_right_fix.strides[2];
    __pyx_t_14.suboffsets[0] = -1;

__pyx_t_6 = __pyx_memoryview_fromslice(__pyx_t_14, 1, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 34, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __PYX_XDEC_MEMVIEW(&__pyx_t_14, 1);
      __pyx_t_14.memview = NULL;
      __pyx_t_14.data = NULL;
      __pyx_t_7 = __Pyx_PyNumber_Int(__pyx_int_0); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 34, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_15 = PyObject_RichCompare(__pyx_t_6, __pyx_t_7, Py_EQ); __Pyx_XGOTREF(__pyx_t_15); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 34, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_7 = NULL;
      ...
      if (!__pyx_t_7) {
        __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_1, __pyx_t_15); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 34, __pyx_L1_error)
...
__pyx_t_17.data = __pyx_v_right_fix.data;
        __pyx_t_17.memview = __pyx_v_right_fix.memview;
...
__pyx_t_17.shape[0] = __pyx_v_right_fix.shape[2];
__pyx_t_17.strides[0] = __pyx_v_right_fix.strides[2];
    __pyx_t_17.suboffsets[0] = -1;

if (unlikely(__pyx_memoryview_copy_contents(__pyx_t_14, __pyx_t_17, 1, 1, 0) < 0)) __PYX_ERR(0, 35, __pyx_L1_error)
 ...
 *                 break
 */
      __pyx_t_16 = ((__pyx_v_l_offset >= 0) != 0);
      if (__pyx_t_16) {
      } else {
        __pyx_t_12 = __pyx_t_16;
      ...
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_all); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_14.data = __pyx_v_right_fix.data;
      __pyx_t_14.memview = __pyx_v_right_fix.memview;
...
{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_l_offset;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_right_fix.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_right_fix.strides[1];
    if (1 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
...
__pyx_t_1 = __pyx_memoryview_fromslice(__pyx_t_14, 1, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __PYX_XDEC_MEMVIEW(&__pyx_t_14, 1);
      __pyx_t_14.memview = NULL;
      __pyx_t_14.data = NULL;
      __pyx_t_15 = __Pyx_PyNumber_Int(__pyx_int_0); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_15);
      __pyx_t_7 = PyObject_RichCompare(__pyx_t_1, __pyx_t_15, Py_EQ); __Pyx_XGOTREF(__pyx_t_7); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
      __pyx_t_15 = NULL;
      ...
      if (!__pyx_t_15) {
        __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_6, __pyx_t_7); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 37, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        __Pyx_GOTREF(__pyx_t_2);
      } else {
        #if CYTHON_FAST_PYCALL
        if (PyFunction_Check(__pyx_t_6)) {
          ...
          __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_6, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 37, __pyx_L1_error)
        ...
        if (__Pyx_PyFastCFunction_Check(__pyx_t_6)) {
          PyObject *__pyx_temp[2] = {__pyx_t_15, __pyx_t_7};
          __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_6, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 37, __pyx_L1_error)
          __Pyx_XDECREF(__pyx_t_15); __pyx_t_15 = 0;
          __Pyx_GOTREF(__pyx_t_2);
          __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        } else
      ...
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_16 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely(__pyx_t_16 < 0)) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
__pyx_t_18.data = __pyx_v_right_fix.data;
        __pyx_t_18.memview = __pyx_v_right_fix.memview;
...
__pyx_t_18.shape[0] = __pyx_v_right_fix.shape[2];
__pyx_t_18.strides[0] = __pyx_v_right_fix.strides[2];
    __pyx_t_18.suboffsets[0] = -1;

if (unlikely(__pyx_memoryview_copy_contents(__pyx_t_14, __pyx_t_18, 1, 1, 0) < 0)) __PYX_ERR(0, 38, __pyx_L1_error)
 ...
 * 
 */
  __PYX_INC_MEMVIEW(&__pyx_v_right_fix, 0);
  __pyx_r = __pyx_v_right_fix;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("shifting_pixel.inpainting", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
/* Python wrapper */
static PyObject *__pyx_pw_14shifting_pixel_3inpainting(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_14shifting_pixel_3inpainting(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_right_fix = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_rows = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_cols = { 0, 0, { 0 }, { 0 }, { 0 } };
  float __pyx_v_deviation;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("inpainting (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_right_fix,&__pyx_n_s_rows,&__pyx_n_s_cols,&__pyx_n_s_deviation,0};
    PyObject* values[4] = {0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_right_fix)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rows)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inpainting", 1, 4, 4, 1); __PYX_ERR(0, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_cols)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inpainting", 1, 4, 4, 2); __PYX_ERR(0, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_deviation)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inpainting", 1, 4, 4, 3); __PYX_ERR(0, 24, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "inpainting") < 0)) __PYX_ERR(0, 24, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 4) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_right_fix = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_right_fix.memview)) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_rows = __Pyx_PyObject_to_MemoryviewSlice_ds_PY_LONG_LONG(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_rows.memview)) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_cols = __Pyx_PyObject_to_MemoryviewSlice_ds_PY_LONG_LONG(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_cols.memview)) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_deviation = __pyx_PyFloat_AsFloat(values[3]); if (unlikely((__pyx_v_deviation == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("inpainting", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 24, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("shifting_pixel.inpainting", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14shifting_pixel_2inpainting(__pyx_self, __pyx_v_right_fix, __pyx_v_rows, __pyx_v_cols, __pyx_v_deviation);
...
static PyObject *__pyx_pf_14shifting_pixel_2inpainting(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_right_fix, __Pyx_memviewslice __pyx_v_rows, __Pyx_memviewslice __pyx_v_cols, float __pyx_v_deviation) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_memviewslice __pyx_t_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_t_2 = NULL;
  __Pyx_RefNannySetupContext("inpainting", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_right_fix.memview)) { __Pyx_RaiseUnboundLocalError("right_fix"); __PYX_ERR(0, 24, __pyx_L1_error) }
  if (unlikely(!__pyx_v_rows.memview)) { __Pyx_RaiseUnboundLocalError("rows"); __PYX_ERR(0, 24, __pyx_L1_error) }
  if (unlikely(!__pyx_v_cols.memview)) { __Pyx_RaiseUnboundLocalError("cols"); __PYX_ERR(0, 24, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_14shifting_pixel_inpainting(__pyx_v_right_fix, __pyx_v_rows, __pyx_v_cols, __pyx_v_deviation, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 24, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 3, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __PYX_XDEC_MEMVIEW(&__pyx_t_1, 1);
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_right_fix, 1);
...
static PyObject *__pyx_pw_14shifting_pixel_5overlap(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_14shifting_pixel_overlap(__Pyx_memviewslice __pyx_v_left_img, __Pyx_memviewslice __pyx_v_right_img, __Pyx_memviewslice __pyx_v_composite, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_width;
  int __pyx_v_height;
  int __pyx_v_i;
  int __pyx_v_j;
 ...
 * 
 */
  __pyx_v_width = ((int)(__pyx_v_left_img.shape[1]));

  /* "shifting_pixel.pyx":47
 *     cdef int width, height, i, j
 *     width = <int>(left_img.shape[1])
 *     height = <int>(left_img.shape[0])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_height = ((int)(__pyx_v_left_img.shape[0]));

  /* "shifting_pixel.pyx":49
 *     height = <int>(left_img.shape[0])
 * 
 *     for i in range(height):             # <<<<<<<<<<<<<<
 ...
 */
          ...
          __pyx_t_13 = -1;
          if (__pyx_t_10 < 0) {
            __pyx_t_10 += __pyx_v_left_img.shape[0];
            if (unlikely(__pyx_t_10 < 0)) __pyx_t_13 = 0;
          } else if (unlikely(__pyx_t_10 >= __pyx_v_left_img.shape[0])) __pyx_t_13 = 0;
          if (__pyx_t_11 < 0) {
            __pyx_t_11 += __pyx_v_left_img.shape[1];
            if (unlikely(__pyx_t_11 < 0)) __pyx_t_13 = 1;
          } else if (unlikely(__pyx_t_11 >= __pyx_v_left_img.shape[1])) __pyx_t_13 = 1;
          if (__pyx_t_12 < 0) {
            __pyx_t_12 += __pyx_v_left_img.shape[2];
            if (unlikely(__pyx_t_12 < 0)) __pyx_t_13 = 2;
          } else if (unlikely(__pyx_t_12 >= __pyx_v_left_img.shape[2])) __pyx_t_13 = 2;
          ...
          __pyx_t_13 = -1;
          if (__pyx_t_14 < 0) {
            __pyx_t_14 += __pyx_v_composite.shape[0];
            if (unlikely(__pyx_t_14 < 0)) __pyx_t_13 = 0;
          } else if (unlikely(__pyx_t_14 >= __pyx_v_composite.shape[0])) __pyx_t_13 = 0;
          if (__pyx_t_15 < 0) {
            __pyx_t_15 += __pyx_v_composite.shape[1];
            if (unlikely(__pyx_t_15 < 0)) __pyx_t_13 = 1;
          } else if (unlikely(__pyx_t_15 >= __pyx_v_composite.shape[1])) __pyx_t_13 = 1;
          if (__pyx_t_16 < 0) {
            __pyx_t_16 += __pyx_v_composite.shape[2];
            if (unlikely(__pyx_t_16 < 0)) __pyx_t_13 = 2;
          } else if (unlikely(__pyx_t_16 >= __pyx_v_composite.shape[2])) __pyx_t_13 = 2;
          if (unlikely(__pyx_t_13 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_13);
            __PYX_ERR(0, 52, __pyx_L7_error)
          }
          *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_composite.data + __pyx_t_14 * __pyx_v_composite.strides[0]) ) + __pyx_t_15 * __pyx_v_composite.strides[1]) ) + __pyx_t_16 * __pyx_v_composite.strides[2]) )) = (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_left_img.data + __pyx_t_10 * __pyx_v_left_img.strides[0]) ) + __pyx_t_11 * __pyx_v_left_img.strides[1]) ) + __pyx_t_12 * __pyx_v_left_img.strides[2]) )));
 ...
 */
          ...
          __pyx_t_13 = -1;
          if (__pyx_t_17 < 0) {
            __pyx_t_17 += __pyx_v_right_img.shape[0];
            if (unlikely(__pyx_t_17 < 0)) __pyx_t_13 = 0;
          } else if (unlikely(__pyx_t_17 >= __pyx_v_right_img.shape[0])) __pyx_t_13 = 0;
          if (__pyx_t_18 < 0) {
            __pyx_t_18 += __pyx_v_right_img.shape[1];
            if (unlikely(__pyx_t_18 < 0)) __pyx_t_13 = 1;
          } else if (unlikely(__pyx_t_18 >= __pyx_v_right_img.shape[1])) __pyx_t_13 = 1;
          if (__pyx_t_19 < 0) {
            __pyx_t_19 += __pyx_v_right_img.shape[2];
            if (unlikely(__pyx_t_19 < 0)) __pyx_t_13 = 2;
          } else if (unlikely(__pyx_t_19 >= __pyx_v_right_img.shape[2])) __pyx_t_13 = 2;
          if (unlikely(__pyx_t_13 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_13);
            __PYX_ERR(0, 59, __pyx_L19_error)
          }
          ...
          __pyx_t_13 = -1;
          if (__pyx_t_20 < 0) {
            __pyx_t_20 += __pyx_v_composite.shape[0];
            if (unlikely(__pyx_t_20 < 0)) __pyx_t_13 = 0;
          } else if (unlikely(__pyx_t_20 >= __pyx_v_composite.shape[0])) __pyx_t_13 = 0;
          if (__pyx_t_21 < 0) {
            __pyx_t_21 += __pyx_v_composite.shape[1];
            if (unlikely(__pyx_t_21 < 0)) __pyx_t_13 = 1;
          } else if (unlikely(__pyx_t_21 >= __pyx_v_composite.shape[1])) __pyx_t_13 = 1;
          if (__pyx_t_22 < 0) {
            __pyx_t_22 += __pyx_v_composite.shape[2];
            if (unlikely(__pyx_t_22 < 0)) __pyx_t_13 = 2;
          } else if (unlikely(__pyx_t_22 >= __pyx_v_composite.shape[2])) __pyx_t_13 = 2;
          if (unlikely(__pyx_t_13 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_13);
            __PYX_ERR(0, 59, __pyx_L19_error)
          }
          *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_composite.data + __pyx_t_20 * __pyx_v_composite.strides[0]) ) + __pyx_t_21 * __pyx_v_composite.strides[1]) ) + __pyx_t_22 * __pyx_v_composite.strides[2]) )) = (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_right_img.data + __pyx_t_17 * __pyx_v_right_img.strides[0]) ) + __pyx_t_18 * __pyx_v_right_img.strides[1]) ) + __pyx_t_19 * __pyx_v_right_img.strides[2]) )));

          /* "shifting_pixel.pyx":60
 *             try:
 *                 composite[i, j, 1] = right_img[i, j, 1]
 *                 composite[i, j, 0] = right_img[i, j, 0]             # <<<<<<<<<<<<<<
 *             except IndexError:
 ...
 */
          ...
          __pyx_t_13 = -1;
          if (__pyx_t_23 < 0) {
            __pyx_t_23 += __pyx_v_right_img.shape[0];
            if (unlikely(__pyx_t_23 < 0)) __pyx_t_13 = 0;
          } else if (unlikely(__pyx_t_23 >= __pyx_v_right_img.shape[0])) __pyx_t_13 = 0;
          if (__pyx_t_24 < 0) {
            __pyx_t_24 += __pyx_v_right_img.shape[1];
            if (unlikely(__pyx_t_24 < 0)) __pyx_t_13 = 1;
          } else if (unlikely(__pyx_t_24 >= __pyx_v_right_img.shape[1])) __pyx_t_13 = 1;
          if (__pyx_t_25 < 0) {
            __pyx_t_25 += __pyx_v_right_img.shape[2];
            if (unlikely(__pyx_t_25 < 0)) __pyx_t_13 = 2;
          } else if (unlikely(__pyx_t_25 >= __pyx_v_right_img.shape[2])) __pyx_t_13 = 2;
          if (unlikely(__pyx_t_13 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_13);
            __PYX_ERR(0, 60, __pyx_L19_error)
          }
          ...
          __pyx_t_13 = -1;
          if (__pyx_t_26 < 0) {
            __pyx_t_26 += __pyx_v_composite.shape[0];
            if (unlikely(__pyx_t_26 < 0)) __pyx_t_13 = 0;
          } else if (unlikely(__pyx_t_26 >= __pyx_v_composite.shape[0])) __pyx_t_13 = 0;
          if (__pyx_t_27 < 0) {
            __pyx_t_27 += __pyx_v_composite.shape[1];
            if (unlikely(__pyx_t_27 < 0)) __pyx_t_13 = 1;
          } else if (unlikely(__pyx_t_27 >= __pyx_v_composite.shape[1])) __pyx_t_13 = 1;
          if (__pyx_t_28 < 0) {
            __pyx_t_28 += __pyx_v_composite.shape[2];
            if (unlikely(__pyx_t_28 < 0)) __pyx_t_13 = 2;
          } else if (unlikely(__pyx_t_28 >= __pyx_v_composite.shape[2])) __pyx_t_13 = 2;
          if (unlikely(__pyx_t_13 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_13);
            __PYX_ERR(0, 60, __pyx_L19_error)
          }
          *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_composite.data + __pyx_t_26 * __pyx_v_composite.strides[0]) ) + __pyx_t_27 * __pyx_v_composite.strides[1]) ) + __pyx_t_28 * __pyx_v_composite.strides[2]) )) = (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_right_img.data + __pyx_t_23 * __pyx_v_right_img.strides[0]) ) + __pyx_t_24 * __pyx_v_right_img.strides[1]) ) + __pyx_t_25 * __pyx_v_right_img.strides[2]) )));
 ...
 */
  ...
  /* "shifting_pixel.pyx":64
 *                 pass
 * 
 *     return composite             # <<<<<<<<<<<<<<
 */
  __PYX_INC_MEMVIEW(&__pyx_v_composite, 0);
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("shifting_pixel.overlap", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
/* Python wrapper */
static PyObject *__pyx_pw_14shifting_pixel_5overlap(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_14shifting_pixel_5overlap(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_left_img = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_right_img = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_composite = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("overlap (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_left_img,&__pyx_n_s_right_img,&__pyx_n_s_composite,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_right_img)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("overlap", 1, 3, 3, 1); __PYX_ERR(0, 44, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_composite)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("overlap", 1, 3, 3, 2); __PYX_ERR(0, 44, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "overlap") < 0)) __PYX_ERR(0, 44, __pyx_L3_error)
      }
    ...
    __pyx_v_left_img = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_left_img.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_right_img = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_right_img.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_composite = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_composite.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("overlap", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 44, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("shifting_pixel.overlap", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14shifting_pixel_4overlap(__pyx_self, __pyx_v_left_img, __pyx_v_right_img, __pyx_v_composite);
...
static PyObject *__pyx_pf_14shifting_pixel_4overlap(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_left_img, __Pyx_memviewslice __pyx_v_right_img, __Pyx_memviewslice __pyx_v_composite) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_memviewslice __pyx_t_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_t_2 = NULL;
  __Pyx_RefNannySetupContext("overlap", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_left_img.memview)) { __Pyx_RaiseUnboundLocalError("left_img"); __PYX_ERR(0, 44, __pyx_L1_error) }
  if (unlikely(!__pyx_v_right_img.memview)) { __Pyx_RaiseUnboundLocalError("right_img"); __PYX_ERR(0, 44, __pyx_L1_error) }
  if (unlikely(!__pyx_v_composite.memview)) { __Pyx_RaiseUnboundLocalError("composite"); __PYX_ERR(0, 44, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_14shifting_pixel_overlap(__pyx_v_left_img, __pyx_v_right_img, __pyx_v_composite, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 44, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 3, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __PYX_XDEC_MEMVIEW(&__pyx_t_1, 1);
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_left_img, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_right_img, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_composite, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "shifting_pixel.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "shifting_pixel._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"shift", (PyCFunction)__pyx_pw_14shifting_pixel_1shift, METH_VARARGS|METH_KEYWORDS, 0},
  {"inpainting", (PyCFunction)__pyx_pw_14shifting_pixel_3inpainting, METH_VARARGS|METH_KEYWORDS, 0},
  {"overlap", (PyCFunction)__pyx_pw_14shifting_pixel_5overlap, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_shifting_pixel(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_shifting_pixel},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_left_img, __pyx_k_left_img, sizeof(__pyx_k_left_img), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_right_fix, __pyx_k_right_fix, sizeof(__pyx_k_right_fix), 0, 0, 1, 1},
  {&__pyx_n_s_right_img, __pyx_k_right_img, sizeof(__pyx_k_right_img), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initshifting_pixel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initshifting_pixel(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_shifting_pixel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_shifting_pixel(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_shifting_pixel(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_shifting_pixel(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("shifting_pixel", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_shifting_pixel) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "shifting_pixel")) {
      if (unlikely(PyDict_SetItemString(modules, "shifting_pixel", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init shifting_pixel", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init shifting_pixel");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
